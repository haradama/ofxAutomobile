...
meta:
	ADDON_NAME = ofxAutomobile
	ADDON_DESCRIPTION = An openframeworks addon to use vehicle signals via OBD2
	ADDON_AUTHOR = Masafumi Harada
	ADDON_TAGS = "addon" "automobile" "vehicle" "OBD2"
	ADDON_URL = https://github.com/haradama/ofxAutomobile
